...
@patch('conda_vendor.conda_vendor._improved_download')
def test_create_repodata_json(mock_download, create_repodata_input,
                              create_repodata_output, download_root):
    ...
    _conda_packages = [ pkg["name"] for _, pkg in repodata["packages.conda"].items() ]
